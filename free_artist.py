...
def download_free_images(json_filename):
    ...
    # --- THE "ECHOES OF REALITY" STYLE GUIDE (OPTIMIZED) ---
    # Changed from "Cyan" (Tech) to "Gold/Marble" (Stoic/Psychology)
    style_modifiers = (
        "aesthetic: Dark Academia, ominous atmosphere, "
        "hyper-detailed marble texture, dramatic chiaroscuro lighting, "
        "black and gold color palette, 8k resolution, Unreal Engine 5 render, "
        "minimalist, cinematic composition, "
        "NO text, NO cartoon, NO blurry faces, NO distorted hands"
    )
